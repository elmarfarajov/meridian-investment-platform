...
def demo_instruments() -> tuple[Instrument, ...]:
    return (
        ...
        Equity(
            ...
            name="Meridian Demonstration Semiconductor (synthetic)",
            currency=USD,
            identifiers=SecurityIdentifiers(ticker=Ticker("DSPL", "XNAS")),
            country="US",
            exchange="XNAS",
            sector="Information Technology",
            industry="Semiconductors",
            issuer_id="DEMO-SEMI",
            metadata={"synthetic": "true", "purpose": "a 4-for-1 split inside the demonstration history"},
        ),
